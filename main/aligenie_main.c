...
static const char *TAG  = "genie_main";
...
void config_triples(void)
{
    ...
    asprintf(&authvalue_string, "%08x,%s,%s", APP_CONFIG_TRIPLES_PRODUCT_ID, APP_CONFIG_TRIPLES_DEVICE_NAME, APP_CONFIG_TRIPLES_DEVICE_SECRET);
    ...
    mac_str2hex(APP_CONFIG_TRIPLES_DEVICE_NAME, ali_mac_address);
